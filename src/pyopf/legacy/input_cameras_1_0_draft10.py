...
from .input_rig_relatives_1_0_draft10 import InputRigRelatives
from .pix4d_input_depth_map_1_0_draft2 import Pix4dInputDepthMap
from .sensor_internals_1_0_draft10 import (
    FisheyeInternals,
    Internals,
...
class InputCameras(BaseItem):
    ...
    def __init__(
        ...
        version: VersionInfo = VersionInfo(1, 0, "draft10"),
    ) -> None:
...
format_and_version_to_type[
    (CoreFormat.INPUT_CAMERAS, VersionInfo(1, 0, "draft10"))
] = InputCameras
