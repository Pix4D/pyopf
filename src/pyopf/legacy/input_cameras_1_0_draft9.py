...
from .input_rig_relatives_1_0_draft9 import InputRigRelatives
from .pix4d_input_depth_map_1_0_draft1 import Pix4dInputDepthMap
from .sensor_internals_1_0_draft9 import (
    FisheyeInternals,
    Internals,
...
class Camera(OpfObject):
    ...
    def from_dict(obj: Any) -> "Camera":
        ...
        sensor_id = Uid64(hex=obj.get("sensor_id"))
        result = Camera(
            id,
            model_source,
            pixel_range,
    ...
    def to_dict(self) -> dict:
        ...
        result["sensor_id"] = str(self.sensor_id)
        return result
...
class InputCameras(BaseItem):
    ...
    def __init__(
        ...
        version: VersionInfo = VersionInfo(1, 0, "draft9"),
    ) -> None:
...
format_and_version_to_type[
    (CoreFormat.INPUT_CAMERAS, VersionInfo(1, 0, "draft9"))
] = InputCameras
